...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="abi" -DDUCKDB_OOT_EXTENSION_ABI_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_ABI_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_ABI_INCLUDE_PATH="$(PROJ_DIR)src/include"
